...
// Per-org Telegram notification settings (migration 0145). Loaded by the
...
export const notification_settings = pgTable("notification_settings", {
  ...
  hourly_window_to: smallint("hourly_window_to").notNull().default(23),
  hourly_interval_hours: smallint("hourly_interval_hours").notNull().default(1),
  active_weekdays: smallint("active_weekdays").array().notNull().default([1, 2, 3, 4, 5, 6, 7]),

...
-- scripts/verify-conversion-reader-switch.ts asserts these copies still agree
-- with the TypeScript definitions on live data.
--
...
attributable AS (
  ...
  FROM (
    ...
    LEFT JOIN conv cv ON cv.stage_send_id = ss.id

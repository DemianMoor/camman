...
async function main() {
  ...
  // absent on prod until those migrations are applied. Without this the run ends
  // in a raw 42703 that looks like a broken EPC.
  await requireReportingColumns(d, "verify-epc-denominator");
